...
// -1, -7, 567, 89, 223-> 3
/*
Console.WriteLine ("Введите M числа через запятую:");
...
Console.WriteLine ("Количество M чисел которые больше 0:"+sum );
...
Console.Write("Введите M числа через пробел: ");
...
Console.WriteLine($"Колличество M чисел которые больше 0: {count}");